...
goto end
:vpn
echo Downloading HackerToolzVPN... (http://hackerto.olz/download?=browser=true,download=true?u45hJUE87Sikjkes8=sourceht?=true=vpn)
echo Downloading... (643kb/384MB)
echo Downloading... (26MB/384MB)
echo Downloading... (175MB/384MB)
echo Downloading... (342MB/384MB)
echo Downloading... (384MB/384MB)
echo Running....
echo Failed to run!
...
echo.
echo 5. Secure VPN
echo Make other people think you're in another country!
echo This uses our VPN, so you are still safe!
echo End!
goto end
:stop
exit
